...
// drive params
inline const std::array<float, 4> pwm_per_omega = {4.393683486709225f, 4.3728115096745634f, 4.563073569555043f, 4.4f};
inline const std::array<float, 4> pwm0 = {37.37094249490049f, 38.53972376000872f, 34.30724861253726f, 40.0f};
